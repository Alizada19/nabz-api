    ...
    return (
        <div className="bg-background font-body-md text-on-background min-h-screen flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md z-10">
                ...
                {/* Login Card */}
                <div className="glass-panel border border-outline-variant rounded-xl shadow-xl p-8 overflow-hidden">
            ...
            {/* Security Overlay (Subtle graphic) */}
            <div className="fixed bottom-8 right-8 opacity-20 pointer-events-none hidden lg:block">
                <div className="w-48 h-48 bg-contain bg-no-repeat" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuANNBtg-j5EAUcrAfr3KR8zitrfjUCLlkezR7sGk5NADSEczwwu5nBANcJyuskW-6sv4ZPSvMcVAnDX5sRms3Ivxg1nTN4BirorViTlpsYdxQDSII-Xn7UdVJ7yPtRsWfCNZg420FGw2FJKsivOiypWiMlXHe6W-2tBXy3gmzIrfA81_iuTz0cWCjNPbtLaOF1zhJvPBcdTgyR5lKuIcflxkXndZAvGjobls-1RgKs4-R9tKkoAe6139g')" }}></div>
            </div>
        </div>
    );
};
