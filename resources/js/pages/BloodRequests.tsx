                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {requestsData?.data.length === 0 ? (
                            ...
                            requestsData?.data.map((req) => (
                                <div
                                    key={req.id}
                                    className="bg-white rounded-xl border border-outline-variant shadow-sm overflow-hidden flex flex-col hover:border-primary/30 transition-colors text-left"
                                >
                                        ...
                                        <div>
                                            <div className="flex justify-between items-start mb-3">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-12 h-12 bg-primary-container text-on-primary-container flex items-center justify-center rounded-lg font-bold text-lg">
                                                        {req.blood_type?.name}
                                                    </div>
                                                    <div>
                                            ...
                                            <div className="space-y-3 mb-6">
                                                <div className="flex items-center gap-2 text-on-surface-variant">
                                                    ...
                                                    <span className="text-xs font-medium">{req.hospital_name}</span>
                                                </div>
                                                <div className="flex items-center gap-2 text-on-surface-variant">
                                        ...
                                        <div className="pt-4 border-t border-outline-variant flex items-center justify-between">
                                            {req.status === 'pending' && (
                                                <div className="flex gap-2 w-full justify-end">
                                                    <button
                                                        ...
                                                        className="py-2 px-4 rounded-lg bg-primary text-white font-label-md text-xs hover:bg-primary-container transition-colors font-bold"
                                                    >
                                                        Approve
                                                    </button>
                                                    <button
                                                        onClick={() => handleUpdateStatus(req.id, 'cancelled')}
                                                        className="py-2 px-4 rounded-lg bg-surface-container-low text-on-surface font-label-md text-xs hover:bg-surface-container-high transition-colors font-bold"
                                                    >
                                                        Cancel
                                                    </button>
                                                </div>
                                            ...
                                            {req.status === 'approved' && (
                                                <button
                                                    ...
                                                    className="w-full py-2 px-4 rounded-lg bg-green-600 text-white font-label-md text-xs hover:bg-green-700 transition-colors font-bold"
                                                >
                                                    Complete Case
                                                </button>
                                            )}
                                            ...
                                            {req.status === 'completed' && (
                                                <span className="text-xs font-bold text-green-700 bg-green-50 px-3 py-1 rounded border border-green-200 w-full text-center">
